            ...
            <div className="Card frame">
              <div className="Card-inner frame">
                ...
                <div className="Text-input frame headline-frame">
                  <div className="Power-Your-Future-text text">Power Your Future with<br/>Data-Driven Solar</div>
                </div>
                ...
                <div className="Horizontal-container frame stats-frame">
                  <div className="Button-container stat-1 frame">
                    ...
                    <div className="Container frame"><div className="label">Communities</div></div>
                  </div>
                  ...
                  <div className="Button-container stat-2 frame">
                    ...
                    <div className="Text-input frame"><div className="label">ROI Generated</div></div>
                  </div>
                  ...
                  <div className="Button-container stat-3 frame">
                    ...
                    <div className="Container frame"><div className="label">Solar Capacity</div></div>
                  </div>
                </div>
